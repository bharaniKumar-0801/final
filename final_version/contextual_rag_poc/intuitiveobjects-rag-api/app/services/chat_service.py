...
async def send_user_message(
    ...
    try:
        ...
        logger.info(f"[last_message] messages: {messages}")
        ...
        logger.info(f'user_query : {message.content}')

        expanded_query = await expand_user_query(conversation, message.content)
        logger.info(f"[send_user_message] expanded_query: {expanded_query}")
        # user query
        ...
        logger.info(f"[send_user_message] expanded_message: {expanded_message}")
        ...
        expanded_message_result = await user_query_collection().insert_one(
            expanded_message.model_dump()
        )

        logger.info(f"[send_user_message] expanded_message_result: {expanded_message_result}")
        ...
        expanded_response_message_result = await user_query_collection().insert_one(
            response_message.model_dump()
        )

        logger.info(f"[send_user_message] expanded_response_message_result: {expanded_response_message_result}")
